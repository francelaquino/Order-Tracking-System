...
const ClientUser = () => {
  ...
  const loadData = async () => {
    try {
      setIsReady(false);
      const result = await request("client/getusers/" + user.Customerid, GET);
      setUsers(result);
      setIsReady(true);
    } catch (e) {
      console.log(e);
  ...
  return (
    <div>
      ...
      <PageBreadCrumb
        ...
        thirdLevel={"Users"}
      />
      <ContainerFluidLayout fullWidth={true} header="Users">
        ...
        >
          ...
          <Column field="Mobileno" header="Mobile No" sortable filter></Column>
